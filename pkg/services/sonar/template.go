...
spec:
  data: >-
    {"nodes":[{"id":"1-1","x":20,"y":20,"role":0,"taskName":"yce-cloud-extensions-sonar-task","anchorPoints":[[0,0.5],[1,0.5]],"addnode":true,"subnode":true,"type":"pipeline-node","linkPoints":{"right":true,"left":true},"style":{}}],"edges":[],"combos":[],"groups":[]}
  width: 1629
  height: 592`
...
spec:
  ...
  resources:
    - name: git-addr
      type: git
  tasks:
    - name: yce-cloud-extensions-sonar-task
      params:
        - name: project_name
...
spec:
  ...
  steps:
    - args:
      ...
      image: 'yametech/checkdocker:v0.1.5'
      name: step1
      resources: {}
    - args:
